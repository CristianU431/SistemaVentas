<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TiendasBuscar.aspx.cs" Inherits="ClienteWeb.TiendasBuscar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">


    <!-- Buscar para la Tabla Tienda -->
    <p> &nbsp;</p>
    <p> &nbsp;</p>
    <h3>Buscar en la Tabla Tienda</h3>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <asp:TextBox runat="server" Id="txtCriterio" class="form-control" type="text" placeholder="Ingrese su criterio"/>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtCriterio" ErrorMessage="Criterio Obligatorio" ValidationGroup="D">*</asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div class="form-group row">
